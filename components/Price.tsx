...
const Price = observer(({ result }: PriceProps) => {
    const {
        ...
        productRef,
        expansion,
        price_textRepresentation: priceString,
        subtitle,
        isFoil
    } = result;
    ...
    const displayTitle = subtitle === '' ? title : title + ' - ' + subtitle;
        ...
        <View style={styles.main_container}>
            ...
            <View style={styles.info_container}>
                ...
                <View style={styles.info}>
                    <Image
                        style={styles.logo}
                        source={getLogoForSeller(seller)}
                    />
                    ...
                    <View style={styles.widgets_container}>
                        <TouchableWithoutFeedback
                            onPress={() =>
                                isBookmarked
                                    ? pricesStore.deleteBookmark(result)
                                    : pricesStore.addBookmarks([result])
                            }
                        >
                        ...
                        <TouchableWithoutFeedback
                            onPress={() => Linking.openURL(productRef)}
                        >
                            <View style={styles.widget}>
                                <Icon
                                    name={'shopping-cart'}
