        ...
        <View style={styles.sf_option_container}>
            ...
            <View>
                {options.map((o: string, i: number) => {
                    return(
                        <TouchableWithoutFeedback onPress={() => setSelected(o)} key={i}>
                            <View style={styles.sf_option_row}>
                                <RadioButton onSelect={() => setSelected(o)} isSelected={selected === o} additionalStyles={{}}/>
...
const Options = observer(() => {
    ...
    const SortAndFilterOptions = [
        { title: 'Price', options: Object.values(sortPriceOptions), selected: pricesStore.sortPriceBy, setSelected: pricesStore.setSortPriceBy, },
        { title: 'Foils', options: Object.values(filterFoilsOptions), selected: pricesStore.filterFoilsBy, setSelected: pricesStore.setFilterFoilsBy },
    ];
